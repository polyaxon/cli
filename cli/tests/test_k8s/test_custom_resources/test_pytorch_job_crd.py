from polyaxon._flow import V1Notification, V1PytorchElasticPolicy, V1SchedulingPolicy
...
class TestPytorchJobCRD(BaseDistributedCRDTestCase):
    ...
    def test_get_pytorch_job_custom_resource(self):
        ...
        crd = get_pytorch_job_custom_resource(
            ...
            elastic_policy=V1PytorchElasticPolicy(
                max_replicas=2,
                min_replicas=1,
            ),
            n_proc_per_node=1,
