...
class OrganizationsV1Api(BaseApi):
    ...
    def create_organization_member(
        ...
        owner: Annotated[StrictStr, Field(..., description="Owner of the namespace")],
        body: Annotated[
            V1OrganizationMember, Field(..., description="Organization body")
        ],
        email: Annotated[
    ...
    def delete_organization_invitation(
        self,
        owner: Annotated[StrictStr, Field(..., description="Owner of the namespace")],
        member_user: Annotated[Optional[StrictStr], Field(description="User.")] = None,
        member_user_email: Annotated[
    ...
    def get_organization_activities(
        ...
        **kwargs
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.get_organization_activities_with_http_info(
    ...
    def patch_organization_member_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["owner", "member_user", "body", "email"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def resend_organization_invitation(
        ...
        **kwargs
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.resend_organization_invitation_with_http_info(
            owner, body, email, **kwargs
        )  # noqa: E501
