...
from polyaxon.k8s.converter.mixins import RayJobMixin
...
from polyaxon.polyflow import V1CompiledOperation, V1Plugins, V1RayJob, V1RayReplica
...
class RayJobConverter(RayJobMixin, BaseConverter):
    def get_resource(
        ...
        workers = [_get_replica(w) for w in job.workers]
