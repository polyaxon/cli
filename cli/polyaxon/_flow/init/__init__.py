...
class V1Init(BaseSchemaModel):
    ...
    Args:
        ...
        artifacts: [V1ArtifactsType](/docs/scheduling/specification/types/#v1artifactstype), optional
        git: [V1GitType](/docs/scheduling/specification/types/#v1gittype), optional
        dockerfile: [V1DockerfileType](/docs/scheduling/specification/types/#v1dockerfiletype), optional
        file: [V1FileType](/docs/scheduling/specification/types/#v1Filetype), optional
        tensorboard: [V1TensorboardType](/docs/scheduling/specification/types/#v1Tensorboardtype), optional
