...
class V1TFJob(BaseRun, DestinationImageMixin):
    ...
    Args:
        ...
        chief: [V1KFReplica](/docs/references/polyaxonfile/runtimes/distributed/kubeflow-replica/), optional
        ps: [V1KFReplica](/docs/references/polyaxonfile/runtimes/distributed/kubeflow-replica/), optional
        worker: [V1KFReplica](/docs/references/polyaxonfile/runtimes/distributed/kubeflow-replica/), optional
        evaluator: [V1KFReplica](/docs/references/polyaxonfile/runtimes/distributed/kubeflow-replica/), optional
